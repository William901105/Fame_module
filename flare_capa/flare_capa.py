...
try:
    import capa.capa.main
    import capa.capa.rules
    import capa.capa.render.result_document as rd
    import capa.capa.render.utils as rutils
...
class FlareCapa(ProcessingModule):
    ...
    def initialize(self):
        if not HAVE_CAPA:
            raise ModuleInitializationError(self, 'Missing dependency: flare-capa in main repo')
